...
{
protected:
	Vector2f position;//toạ độ bóng (float x, float y)
	...
	double MaxVelocity = 20.0f;//vận tốc tối đa
...
public:
	...
	//Thay đổi vận tốc bóng
	//input: vận tốc theo trục x, y
	void SetVelocity(float xVelocity, float yVelocity);

	//Trả về chính hình dạnh bóng nhằm sử dụng các hàm điều chỉnh trực tiếp các tính chất của bóng
	...
	void Update(double deltaTime, VideoMode mode, AudioManager& audio, Player& player1, Player& player2, PlayGround& playground, float Scale);
